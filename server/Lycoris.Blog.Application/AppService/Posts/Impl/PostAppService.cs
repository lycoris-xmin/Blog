...
namespace Lycoris.Blog.Application.AppService.Posts.Impl
{
    ...
    public class PostAppService : ApplicationBaseService, IPostAppService
    {
        ...
        public async Task SaveAsync(PostSaveDto input)
        {
            ...
            await _scheduleQueue.Value.EnqueueAsync(ScheduleTypeEnum.CategoryPostCount, oldCategory.ToString());
            await _scheduleQueue.Value.EnqueueAsync(ScheduleTypeEnum.CategoryPostCount, data.Category.ToString());
        }
