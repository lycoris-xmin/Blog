...
namespace Lycoris.Blog.Application.AppServices.FileManage.Impl
{
    ...
    public class FileManageAppService : ApplicationBaseService, IFileManageAppService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<FileUploadConfiguration?> CheckMinioUseAsync() => ApplicationConfiguration.Value.GetConfigurationAsync<FileUploadConfiguration>(AppConfig.FileUpload);
