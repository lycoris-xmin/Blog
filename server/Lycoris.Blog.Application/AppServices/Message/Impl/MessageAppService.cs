...
namespace Lycoris.Blog.Application.AppServices.Message.Impl
{
    ...
    public class MessageAppService : ApplicationBaseService, IMessageAppService
    {
        ...
        public MessageAppService(IRepository<LeaveMessage, int> message, Lazy<IRepository<User, long>> user, Lazy<IScheduleQueueCacheService> scheduleQueueCache)
        {
            _message = message;
            _user = user;
