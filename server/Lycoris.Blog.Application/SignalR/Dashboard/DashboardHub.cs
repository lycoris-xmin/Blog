...
namespace Lycoris.Blog.Application.SignalR.Dashboard
{
    /// <summary>
    /// 
    /// </summary>
    public class DashboardHub : Hub
    {
        ...
        public override async Task OnDisconnectedAsync(Exception? exception)
        {
            ...
            // 
            if (_serverMonitor.ConnectionIds.Contains(this.Context.ConnectionId))
            {
                _serverMonitor.ConnectionIds.Remove(this.Context.ConnectionId);
                await this.Groups.RemoveFromGroupAsync("ServerMonitor", this.Context.ConnectionId);
            }
        ...
        {
            _serverMonitor.ConnectionIds.Add(this.Context.ConnectionId);
