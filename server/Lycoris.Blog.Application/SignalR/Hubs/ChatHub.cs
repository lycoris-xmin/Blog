    ...
    public class ChatHub : Hub
    {
        ...
        public async Task SendMessageAsync(SendMessageInput input)
        {
            try
            {
                ...
                {
                    var message = await _chatSignalRService.CreateChatMessageAsync(new CreateChatMessageModel()
                    {
                    ...
                    var data = message.ToMap<ChatMessageSignalRModel>();

                    await PublishGroupMessageAsync(input.RoomId, new DataOutput<ChatMessageSignalRModel>()
                    {
                    ...
                    await PublishMessageAckAsync(new DataOutput<ChatMessageSignalRModel>()
                    {
                        ResCode = ResCodeEnum.Success,
                        ResMsg = "",
                        Data = data
            ...
            catch (Exception ex)
            {
                ...
                await PublishMessageAckAsync(new DataOutput<ChatMessageSignalRModel>()
                {
                    ...
                    ResMsg = "系统异常，消息发送失败",
                    Data = new ChatMessageSignalRModel(input.MessageId)
                });
            }
        }
