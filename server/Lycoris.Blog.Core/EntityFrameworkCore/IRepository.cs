using Lycoris.Blog.Core.EntityFrameworkCore.Impl;
using Lycoris.Blog.EntityFrameworkCore.Shared;
using MySqlConnector;
using System.Diagnostics.CodeAnalysis;
using System.Linq.Expressions;

namespace Lycoris.Blog.Core.EntityFrameworkCore
{
    /// <summary>
    /// 数据库仓储
    /// </summary>
    ...
    public interface IRepository<T, TPrimary> where T : MySqlBaseEntity<TPrimary>
    {
        ...
        /// <returns></returns>
        T CreateOrUpdate(T data, params Expression<Func<T, object>>[] fieIds);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        T CreateOrUpdate(T data, List<Expression<Func<T, object>>> fieIds);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        Task<T> CreateOrUpdateAsync(T data, params Expression<Func<T, object>>[] fieIds);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        Task<T> CreateOrUpdateAsync(T data, List<Expression<Func<T, object>>> fieIds);
        #endregion
