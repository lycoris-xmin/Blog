...
namespace Lycoris.Blog.Core.EntityFrameworkCore.Impl
{
    /// <summary>
    /// 数据库仓储
    /// </summary>
    ...
    public class Repository<T, TPrimary> : IRepository<T, TPrimary> where T : MySqlBaseEntity<TPrimary>
    {
        ...
        /// <returns></returns>
        public T CreateOrUpdate(T data, params Expression<Func<T, object>>[] fieIds)
        {
            var type = typeof(TPrimary);
            if ((type == typeof(int) || type == typeof(long)) && (data.Id == null || data.Id.ToString() == "0"))
                return Create(data);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        public T CreateOrUpdate(T data, List<Expression<Func<T, object>>> fieIds)
        {
            var type = typeof(TPrimary);
            if ((type == typeof(int) || type == typeof(long)) && (data.Id == null || data.Id.ToString() == "0"))
                return Create(data);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        public async Task<T> CreateOrUpdateAsync(T data, params Expression<Func<T, object>>[] fieIds)
        {
            var type = typeof(TPrimary);
            if ((type == typeof(int) || type == typeof(long)) && (data.Id == null || data.Id.ToString() == "0"))
                return await CreateAsync(data);
        ...
        /// <param name="fieIds"></param>
        /// <returns></returns>
        public async Task<T> CreateOrUpdateAsync(T data, List<Expression<Func<T, object>>> fieIds)
        {
            var type = typeof(TPrimary);
            if ((type == typeof(int) || type == typeof(long)) && (data.Id == null || data.Id.ToString() == "0"))
                return await CreateAsync(data);
