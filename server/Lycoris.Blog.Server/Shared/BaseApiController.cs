...
namespace Lycoris.Blog.Server.Shared
{
    ...
    public class BaseApiController : ControllerBase
    {
        ...
        /// <returns></returns>
        protected virtual DataOutput<T> Success<T>(T? data) where T : class
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        protected virtual ListOutput<T> Success<T>(List<T>? list) where T : class
        {
        ...
        /// <returns></returns>
        protected virtual PageOutput<T> Success<T>(int count, List<T>? list) where T : class
        {
        ...
        /// <param name="list"></param>
        /// <returns></returns>
        protected virtual PageOutput<T> Success<T>(int count, T? summary, List<T>? list) where T : class
        {
            var obj = new PageOutput<T>
            {
                ResCode = ResCodeEnum.Success,
