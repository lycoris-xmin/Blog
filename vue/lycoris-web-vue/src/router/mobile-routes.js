...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/post/:postid',
        name: 'post',
        component: () => import('../views/pc/post/index.vue'),
        meta: {
          keepAlive: false
        }
      },
      {
        path: '/talks',
        name: 'talks',
        component: () => import('../views/pc/talks/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '说说',
          navHeader: true
      ...
      },
      {
        path: '/message',
        name: 'message',
        component: () => import('../views/pc/leavemessage/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '留言',
          navHeader: true
      ...
      },
      {
        path: '/navigation',
        name: 'navigation',
        component: () => import('../views/pc/navigation/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '网站收录',
          navHeader: true,
      ...
      },
      {
        path: '/cooperate',
        name: 'cooperate',
        component: () => import('../views/pc/cooperate/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '开发合作',
          navHeader: true,
      ...
      },
      {
        path: '/other',
        name: 'other',
        component: () => import('../views/pc/other/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '其他',
          navHeader: true,
      ...
      },
      {
        path: '/friends',
        name: 'friends',
        component: () => import('../views/pc/friend-link/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '友情链接',
          navHeader: true
      ...
      },
      {
        path: '/about/web',
        name: 'aboutweb',
        component: () => import('../views/pc/about-web/index.vue'),
        meta: {
          keepAlive: true,
          pageName: '关于本站',
          navHeader: true
      ...
      },
      {
        ...
        name: 'tesseract',
        component: () => import('../views/pc/tesseract/index.vue'),
        meta: {
          keepAlive: true
        }
      },
  ...
  },
  {
    path: '/about/me',
    name: 'aboutme',
    component: () => import('../views/pc/about-me/index.vue'),
    meta: {
      title: '关于我',
      keepAlive: true,
      navHeader: true
  ...
  },
  {
    ...
    name: 'notfound',
    component: () => import('../views/pc/server-notfound.vue'),
    meta: {
      title: '小破站资源丢失啦',
      keepAlive: false
    }
  },
  {
    path: '/server/error',
    name: 'server-error',
    component: () => import('../views/pc/server-error.vue'),
    meta: {
      title: '小破站服务崩溃啦',
      keepAlive: false
    }
  },
  {
    ...
    name: 'nav-jump',
    component: () => import('../views/pc/nav-jump.vue'),
    meta: {
      title: '跳转说明',
      keepAlive: false
    }
...
export const getMobilePageRoutes = () => {
  let config = [];
...
export const getMobileKeepAliveComponents = () => {
  let compoents = [];
...
export const getMobileNavMenus = childrens => {
  let nav = [];

  for (let item of childrens || routes) {
    if (item.children && item.children.length) {
      nav = [...nav, ...getMobileNavMenus(item.children)];
